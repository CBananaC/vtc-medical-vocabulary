const CACHE_NAME = "ielts-vocab-pwa-v47-20260923-practice-history-feed";
...
const APP_SHELL = [
  ...
  "/icon-192.png",
  "/icon-512.png",
  "/app.js?v=20260923-practice-history-feed-v1",
  "/styles.css?v=20260923-practice-history-feed-v1"
];
