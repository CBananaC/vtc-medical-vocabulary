const CACHE_NAME = "ielts-vocab-pwa-v50-20260923-practice-history-buttons";
...
const APP_SHELL = [
  ...
  "/icon-192.png",
  "/icon-512.png",
  "/app.js?v=20260923-practice-history-buttons-v1",
  "/styles.css?v=20260923-practice-history-buttons-v1"
];
